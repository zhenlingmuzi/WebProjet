  ...
  DB.accessor.query(sql).then(() => {
    return request(app).put('/characters/' + putCharacter.parameters.id).send(putCharacter.body).then(res => {
      ...
      t.deepEqual(_rec14._expr(_rec14._capt(_rec14._capt(res, 'arguments/0/object').body, 'arguments/0'), {
        ...
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"res","range":[12,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"body","range":[16,20]},{"type":{"label":","},"range":[20,21]},{"type":{"label":"name"},"value":"deleteCharacter","range":[22,37]},{"type":{"label":"."},"range":[37,38]},{"type":{"label":"name"},"value":"result","range":[38,44]},{"type":{"label":")"},"range":[44,45]}]',
        visitorKeys: _powerAssertVisitorKeys
      }), _rec15._expr(_rec15._capt(_rec15._capt(deleteCharacter, 'arguments/1/object').result, 'arguments/1'), {
        content: 't.deepEqual(res.body, deleteCharacter.result)',
        filepath: 'tests\\characters-tests.js',
        line: 83,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[12,15]},"property":{"type":"Identifier","name":"body","range":[16,20]},"computed":false,"range":[12,20]},{"type":"MemberExpression","object":{"type":"Identifier","name":"deleteCharacter","range":[22,37]},"property":{"type":"Identifier","name":"result","range":[38,44]},"computed":false,"range":[22,44]}],"range":[0,45]}',
...
//# sourceMappingURL=..\node_modules\.cache\ava\e7194463e7bbbfdf269bebe399912379.js.map